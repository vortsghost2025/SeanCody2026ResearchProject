...
- **A:** source, artifact, publication, event, or relationship directly confirmed;
- **B:** well-supported interpretation with remaining uncertainty;
...
**Maintenance rule:** update this page whenever a system, major domain, active research question, confirmed bridge, significant contradiction, or acquisition priority changes.
