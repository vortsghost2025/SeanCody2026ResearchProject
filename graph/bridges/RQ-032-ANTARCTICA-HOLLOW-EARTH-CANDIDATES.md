...
| ID | Candidate | Suspected mechanisms | Priority | Current status |
|---|---|---|---|---|
...
| `BRIDGE-032-008` | Byrd phrase and/or Highjump publicity → Bernard and later secret-mission narratives | `LEXICAL_MIGRATION`, `INSTITUTIONAL_LAUNDERING`, `SHARED_ERROR` | HIGH | `SPLIT REQUIRED` |
